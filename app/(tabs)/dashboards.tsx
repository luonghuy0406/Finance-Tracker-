...
export default function DashboardScreen() {
  ...
  const { income, expenses, balance, walletSummaries } = calculateFinancialSummary(filteredTransactions, wallets);
                ...
                {/* <View style={styles.walletSummariesContainer}>
                  ...
                  {Object.entries(walletSummaries).map(([walletId, summary]: [string, any]) => (
                    <View key={walletId} style={styles.walletSummaryItem}>
                      ...
                      <Text style={styles.spentAmount}>{t("spent")}: {formatCurrency(summary.spent)}</Text>
